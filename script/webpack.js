...
umdMin.output.filename = "./dist/queue-umd.min.js";
...
amd.output.filename = "./dist/queue-amd.js";


var cjs2 = baseConfig();
delete cjs2.output.library;
cjs2.output.libraryTarget = "commonjs2";
cjs2.output.filename = "./dist/queue-commonjs.js";
...
system.output.filename = "./dist/queue-systemjs.js";


var browser = baseConfig();
browser.output.libraryTarget = "var";
browser.output.filename = "./dist/queue.js";


var browserMin = baseConfig();
browserMin.output.libraryTarget = "var";
browserMin.output.filename = "./dist/queue.min.js";
